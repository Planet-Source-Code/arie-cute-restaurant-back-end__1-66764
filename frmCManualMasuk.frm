...
Begin VB.Form frmCManualMasuk 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Inventory Adjustment (Increase)"
   ClientHeight    =   6090
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   11430
   ...
   Begin VB.Frame fraFind 
      ...
      Top             =   60
      Width           =   3375
      Begin VB.CommandButton cmdCetakMM 
         Caption         =   "&Cetak Form"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
         ...
         Height          =   375
         Left            =   0
         Picture         =   "frmCManualMasuk.frx":0000
         TabIndex        =   2
         Top             =   5580
         Width           =   3315
      End
      Begin TabDlg.SSTab TabIndek 
         ...
         EndProperty
         TabCaption(0)   =   "Indeks"
         TabPicture(0)   =   "frmCManualMasuk.frx":030A
         Tab(0).ControlEnabled=   0   'False
         Tab(0).Control(0)=   "txtIndeks"
         Tab(0).Control(1)=   "lstIndeks"
         Tab(0).ControlCount=   2
         TabCaption(1)   =   "Cari"
         TabPicture(1)   =   "frmCManualMasuk.frx":0326
         ...
         Begin VB.ComboBox cboBy 
            Height          =   315
            ItemData        =   "frmCManualMasuk.frx":0342
            Left            =   240
            List            =   "frmCManualMasuk.frx":0349
         ...
         Begin VB.ListBox lstCari 
            Height          =   3375
            ItemData        =   "frmCManualMasuk.frx":035D
            Left            =   240
            List            =   "frmCManualMasuk.frx":0364
            TabIndex        =   18
            Top             =   1860
            Width           =   2835
         End
   ...
   Begin VB.Frame fraFields 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin VB.CommandButton cmdBarang 
            ...
            Height          =   375
            Left            =   2580
            Picture         =   "frmCManualMasuk.frx":0371
            TabIndex        =   12
            Top             =   3780
            Width           =   2595
         End
         ...
         Begin MSDataGridLib.DataGrid dgPI 
            Bindings        =   "frmCManualMasuk.frx":067B
            Height          =   1755
            Left            =   60
            TabIndex        =   24
            Top             =   1500
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Caption         =   "Item Inventory yang masuk"
            ColumnCount     =   6
         ...
         Begin VB.Label lblInv 
            AutoSize        =   -1  'True
            BackStyle       =   0  'Transparent
            Caption         =   "Total Nilai Barang Masuk"
            ForeColor       =   &H00FFFFFF&
            Height          =   195
            Index           =   12
            Left            =   4020
      ...
      Begin VB.Image Image2 
         Height          =   570
         Left            =   180
         Picture         =   "frmCManualMasuk.frx":0690
         Stretch         =   -1  'True
         Top             =   60
         Width           =   525
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdUpdate 
         ...
         Height          =   795
         Left            =   9540
         Picture         =   "frmCManualMasuk.frx":0F5A
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   5160
         Picture         =   "frmCManualMasuk.frx":1264
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   0
         Width           =   795
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   4320
         Picture         =   "frmCManualMasuk.frx":156E
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   0
         Width           =   795
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   3480
         Picture         =   "frmCManualMasuk.frx":1878
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   0
         Width           =   795
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   6000
         Picture         =   "frmCManualMasuk.frx":1B82
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   0
         Width           =   795
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   10380
         Picture         =   "frmCManualMasuk.frx":1E8C
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   9540
         Picture         =   "frmCManualMasuk.frx":2196
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   0
         Width           =   795
      ...
      Begin VB.CommandButton cmdClose 
         ...
         Height          =   795
         Left            =   10380
         Picture         =   "frmCManualMasuk.frx":24A0
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   0
         Width           =   795
   ...
   End
End
Attribute VB_Name = "frmCManualMasuk"
...
Private Sub ProsesDetail()
  ...
  If adoPrimaryRS.RecordCount <> 0 Then
    dgPI.Caption = "Inventory yang masuk berdasarkan kode " & adoPrimaryRS!KodeRef
  End If
  dgPI.ReBind
  '
End Sub
...
Private Sub Form_Load()
  ...
  adoPrimaryRS.Open "Select * from [C_ManualMasuk] Order by KodeRef", db, adOpenStatic, adLockOptimistic
...
Private Sub cmdUpdate_Click()
  ...
  rsHistory!Keterangan = "Inventory Adjustment oleh " & txtFields(3).Text
...
Private Sub RefreshIndeks()
  ...
  rsIndeks.Open "Select KodeRef FROM [C_ManualMasuk]", db, adOpenStatic, adLockOptimistic
  Indeks
  '
End Sub
...
Private Sub txtIndeks_Change()
  '
  Set rsIndeks = New ADODB.Recordset
  rsIndeks.Open "Select KodeRef FROM [C_ManualMasuk] WHERE KodeRef LIKE '%" & txtIndeks.Text & "%'", db, adOpenStatic, adLockOptimistic
  Indeks
  '
End Sub
...
Private Sub cmdTampil_Click()
  ...
  Select Case cboBy.ListIndex
    Case 0
      rsCari.Open "Select * FROM [C_ManualMasuk] WHERE KodeRef LIKE '%" & txtCari.Text & "%' Order By KodeRef", db, adOpenStatic, adLockOptimistic
  End Select
  '
  Cari
  rsCari.Close
...
Private Sub cmdBarang_Click()
  '
  If (frmCManualMasuk.txtFields(0).Text = "") Then
    MsgBox "Nomor Kode Referensi tidak boleh kosong", vbCritical
    txtFields(0).SetFocus
    Exit Sub
  End If
  '
  frmCManualMasukDetail.Caption = "No. Referensi : " & adoPrimaryRS!KodeRef & " - Inventory yang masuk"
  frmCManualMasukDetail.Show vbModal
  ProsesDetail
  '
End Sub

Private Sub cmdCetakMM_Click()
  '
  Dim sSQL As String
  '
  If adoPrimaryRS.RecordCount = 0 Then
  ...
  End If
  '
  sSQL = "SELECT C_ManualMasuk.KodeRef, C_ManualMasuk.Tanggal, C_ManualMasuk.Keterangan, C_IStockCard.Inventory, C_IStockCard.NamaInventory, C_IStockCard.UnitMasuk, C_IStockCard.SatuanBesar, C_IStockCard.Harga, C_IStockCard.HargaSubTotal FROM C_ManualMasuk INNER JOIN C_IStockCard ON C_ManualMasuk.KodeRef = C_IStockCard.PI WHERE (((C_ManualMasuk.KodeRef)='" & txtFields(0).Text & "'))"
  ...
  With frmUtama.crReport
    ...
    .WindowTitle = "Form Inventory Adjustment (Increase)"
    .ReportFileName = App.Path & "\Report\Laporan IAdjustment Increase.Rpt"
