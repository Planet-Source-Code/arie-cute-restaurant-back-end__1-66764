...
Begin VB.Form frmCManualKeluar 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Inventory Adjustment (Decrease)"
   ClientHeight    =   6075
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   11415
   ...
   Begin VB.Frame fraFind 
      ...
      Top             =   60
      Width           =   3375
      Begin VB.CommandButton cmdCetakKM 
         Caption         =   "&Cetak Form"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
         ...
         Height          =   375
         Left            =   0
         Picture         =   "frmCManualKeluar.frx":0000
         TabIndex        =   2
         Top             =   5580
         Width           =   3315
      End
      Begin TabDlg.SSTab TabIndek 
         ...
         EndProperty
         TabCaption(0)   =   "Indeks"
         TabPicture(0)   =   "frmCManualKeluar.frx":030A
         Tab(0).ControlEnabled=   0   'False
         Tab(0).Control(0)=   "lstIndeks"
         Tab(0).Control(1)=   "txtIndeks"
         Tab(0).ControlCount=   2
         TabCaption(1)   =   "Cari"
         TabPicture(1)   =   "frmCManualKeluar.frx":0326
         ...
         Begin VB.ListBox lstCari 
            Height          =   3375
            ItemData        =   "frmCManualKeluar.frx":0342
            Left            =   240
            List            =   "frmCManualKeluar.frx":0349
            TabIndex        =   18
            Top             =   1860
            Width           =   2835
         End
         ...
         Begin VB.ComboBox cboBy 
            Height          =   315
            ItemData        =   "frmCManualKeluar.frx":0356
            Left            =   240
            List            =   "frmCManualKeluar.frx":035D
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   795
         Left            =   10380
         Picture         =   "frmCManualKeluar.frx":0371
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdLast 
         ...
         Height          =   795
         Left            =   6000
         Picture         =   "frmCManualKeluar.frx":067B
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   0
         Width           =   795
      ...
      Begin VB.CommandButton cmdFirst 
         ...
         Height          =   795
         Left            =   3480
         Picture         =   "frmCManualKeluar.frx":0985
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   0
         Width           =   795
      ...
      Begin VB.CommandButton cmdPrevious 
         ...
         Height          =   795
         Left            =   4320
         Picture         =   "frmCManualKeluar.frx":0C8F
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   0
         Width           =   795
      ...
      Begin VB.CommandButton cmdNext 
         ...
         Height          =   795
         Left            =   5160
         Picture         =   "frmCManualKeluar.frx":0F99
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   0
         Width           =   795
      ...
      Begin VB.CommandButton cmdUpdate 
         ...
         Height          =   795
         Left            =   9540
         Picture         =   "frmCManualKeluar.frx":12A3
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   795
         Left            =   9540
         Picture         =   "frmCManualKeluar.frx":15AD
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   0
         Width           =   795
      ...
      Begin VB.CommandButton cmdClose 
         ...
         Height          =   795
         Left            =   10380
         Picture         =   "frmCManualKeluar.frx":18B7
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   0
         Width           =   795
   ...
   Begin VB.Frame fraFields 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin VB.CommandButton cmdBarang 
            ...
            Height          =   375
            Left            =   2580
            Picture         =   "frmCManualKeluar.frx":1BC1
            TabIndex        =   12
            Top             =   3780
            Width           =   2595
         End
         ...
         Begin MSDataGridLib.DataGrid dgPI 
            Bindings        =   "frmCManualKeluar.frx":1ECB
            Height          =   1755
            Left            =   60
            TabIndex        =   27
            Top             =   1500
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Caption         =   "Item Inventory yang keluar"
            ColumnCount     =   6
         ...
         Begin VB.Label lblInv 
            AutoSize        =   -1  'True
            BackStyle       =   0  'Transparent
            Caption         =   "Total Nilai Barang Keluar"
            ForeColor       =   &H00FFFFFF&
            Height          =   195
            Index           =   12
            Left            =   4080
      ...
      Begin VB.Image Image2 
         Height          =   570
         Left            =   240
         Picture         =   "frmCManualKeluar.frx":1EE0
         Stretch         =   -1  'True
         Top             =   60
         Width           =   525
      End
   ...
   End
End
Attribute VB_Name = "frmCManualKeluar"
...
Private Sub Form_Load()
  ...
  adoPrimaryRS.Open "select * from [C_ManualKeluar] Order by KodeRef", db, adOpenStatic, adLockOptimistic
...
Private Sub RefreshIndeks()
  ...
  rsIndeks.Open "Select KodeRef FROM [C_ManualKeluar]", db, adOpenStatic, adLockOptimistic
  Indeks
  '
End Sub
...
Private Sub txtIndeks_Change()
  '
  Set rsIndeks = New ADODB.Recordset
  rsIndeks.Open "Select KodeRef FROM [C_ManualKeluar] WHERE KodeRef LIKE '%" & txtIndeks.Text & "%'", db, adOpenStatic, adLockOptimistic
  Indeks
  '
End Sub
...
Private Sub cmdTampil_Click()
  ...
  Select Case cboBy.ListIndex
    Case 0
      rsCari.Open "Select * FROM [C_ManualKeluar] WHERE KodeRef LIKE '%" & txtCari.Text & "%' Order By KodeRef", db, adOpenStatic, adLockOptimistic
  End Select
  '
  Cari
  rsCari.Close
...
Private Sub cmdBarang_Click()
  '
  If (frmCManualKeluar.txtFields(0).Text = "") Then
    MsgBox "Nomor Kode Referensi tidak boleh kosong", vbCritical
    txtFields(0).SetFocus
    Exit Sub
  End If
  '
  frmCManualKeluarDetail.Caption = "No. Referensi : " & adoPrimaryRS!KodeRef & " - Inventory yang keluar"
  frmCManualKeluarDetail.Show vbModal
  ProsesDetail
  '
End Sub

Private Sub cmdCetakKM_Click()
  '
  Dim sSQL As String
  '
  If adoPrimaryRS.RecordCount = 0 Then
  ...
  End If
  '
  sSQL = "SELECT C_ManualKeluar.KodeRef, C_ManualKeluar.Tanggal, C_ManualKeluar.Keterangan, C_IStockCard.Inventory, C_IStockCard.NamaInventory, C_IStockCard.UnitKeluar, C_IStockCard.SatuanBesar, C_IStockCard.Harga, C_IStockCard.HargaSubTotal FROM C_ManualKeluar INNER JOIN C_IStockCard ON C_ManualKeluar.KodeRef = C_IStockCard.PI WHERE (((C_ManualKeluar.KodeRef)='" & txtFields(0).Text & "'))"
  ...
  With frmUtama.crReport
    ...
    .WindowTitle = "Form Inventory Adjustment (Decrease)"
    .ReportFileName = App.Path & "\Report\Laporan IAdjustment Decrease.Rpt"
