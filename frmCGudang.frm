...
Begin VB.Form frmCGudang 
   ...
   Begin VB.Frame fraFind 
      ...
      Begin TabDlg.SSTab TabIndek 
         ...
         EndProperty
         TabCaption(0)   =   "Indeks"
         TabPicture(0)   =   "frmCGudang.frx":1B5A
         Tab(0).ControlEnabled=   0   'False
         Tab(0).Control(0)=   "txtIndeks"
         Tab(0).Control(1)=   "lstIndeks"
         Tab(0).ControlCount=   2
         TabCaption(1)   =   "Cari"
         TabPicture(1)   =   "frmCGudang.frx":1B76
         ...
         Begin VB.ComboBox cboBy 
            Height          =   315
            ItemData        =   "frmCGudang.frx":1B92
            Left            =   240
            List            =   "frmCGudang.frx":1B9C
         ...
         Begin VB.ListBox lstCari 
            Height          =   645
            ItemData        =   "frmCGudang.frx":1BBA
            Left            =   240
            List            =   "frmCGudang.frx":1BC1
            TabIndex        =   16
            Top             =   1860
            Width           =   2835
         End
...
Private Sub Form_Load()
  ...
  adoPrimaryRS.Open "Select * from [C_Gudang] Order by NamaGudang", db, adOpenStatic, adLockOptimistic
...
Private Sub cmdEdit_Click()
  ...
  If adoPrimaryRS.RecordCount = 0 Then
    MsgBox "Data Gudang kosong", vbCritical
    Exit Sub
  End If
...
Private Sub RefreshIndeks()
  ...
  rsIndeks.Open "Select NamaGudang FROM [C_Gudang] Order By NamaGudang", db, adOpenStatic, adLockOptimistic
  Indeks
  '
End Sub
...
Private Sub Indeks()
  ...
  Do While Not rsIndeks.EOF
    lstIndeks.AddItem rsIndeks!NamaGudang
    rsIndeks.MoveNext
  Loop
...
Private Sub Cari()
  ...
  Do While Not rsCari.EOF
    lstCari.AddItem rsCari!NamaGudang
    rsCari.MoveNext
  Loop
  Me.MousePointer = vbDefault
  '
...
Private Sub txtIndeks_Change()
  '
  Set rsIndeks = New ADODB.Recordset
  rsIndeks.Open "Select NamaGudang FROM [C_Gudang] WHERE NamaGudang LIKE '%" & txtIndeks.Text & "%' Order By NamaGudang", db, adOpenStatic, adLockOptimistic
  Indeks
  '
End Sub
...
Private Sub lstIndeks_Click()
  ...
  '
  adoPrimaryRS.MoveFirst
  adoPrimaryRS.Find "NamaGudang ='" & lstIndeks.Text & "'"
  Exit Sub
...
Private Sub cmdTampil_Click()
  ...
  Select Case cboBy.ListIndex
    Case 0
      rsCari.Open "Select * FROM [C_Gudang] WHERE Gudang LIKE '%" & txtCari.Text & "%' Order By Gudang", db, adOpenStatic, adLockOptimistic
    Case 1
      rsCari.Open "Select * FROM [C_Gudang] WHERE NamaGudang LIKE '%" & txtCari.Text & "%' Order By NamaGudang", db, adOpenStatic, adLockOptimistic
  End Select
  '
  Cari
  rsCari.Close
...
Private Sub lstCari_Click()
  ...
  '
  adoPrimaryRS.MoveFirst
  adoPrimaryRS.Find "NamaGudang ='" & lstCari.Text & "'"
  Exit Sub
