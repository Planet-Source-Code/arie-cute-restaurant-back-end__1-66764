...
Begin VB.Form frmCManualMasukDetail 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Inventory yang Masuk"
   ClientHeight    =   3690
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5790
   ...
   Begin VB.CommandButton cmdUpdate 
      ...
      Height          =   795
      Left            =   2100
      Picture         =   "frmCManualMasukDetail.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   2820
      Width           =   795
   ...
   Begin VB.CommandButton cmdClose 
      ...
      Height          =   795
      Left            =   2940
      Picture         =   "frmCManualMasukDetail.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   2820
      Width           =   795
   ...
   Begin VB.Image Image2 
      Height          =   570
      Left            =   120
      Picture         =   "frmCManualMasukDetail.frx":0614
      Stretch         =   -1  'True
      Top             =   60
      Width           =   525
   End
   ...
   End
End
Attribute VB_Name = "frmCManualMasukDetail"
...
Private Sub cmdUpdate_Click()
  ...
  If dcInventory.Text = "" Then
    MsgBox "Data Inventory yang masuk tidak boleh kosong", vbCritical
    dcInventory.SetFocus
    Exit Sub
  End If
  iCounter = JumlahRecord("Select * From [C_IStockCard] Where Inventory = '" & dcInventory.BoundText & "' And PI = '" & frmCManualMasuk.txtFields(0).Text & "'", db)
  If iCounter > 0 Then
  ...
  rsKembaliInventory!Tanggal = frmCManualMasuk.txtFields(1).Text
  ...
  rsKembaliInventory!PI = frmCManualMasuk.txtFields(0).Text
  rsKembaliInventory!Keterangan = "Inventory Adjustment (Increase)"
  ...
  rsHistoryDetail!KodeRef = frmCManualMasuk.txtFields(0).Text
  ...
  '
  CompStockMasuk = (txtFields(0).Text * Konversi) + txtFields(3).Text
  '
  If bolResep Then
  ...
  End If
  '
  frmCManualMasuk.txtFields(7).Text = CCur(frmCManualMasuk.txtFields(7).Text) + CCur(txtFields(2).Text)
